...
* **Isolation guarantee:** VLAN 140 is firewalled from all production tiers; preview data is disposable and destroyed with the environment. Full guide: `docs/11-pr-preview-environments.md`.
