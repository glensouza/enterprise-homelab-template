...
// Local dev only: homelab credentials come from Infisical (ADR 12) and never
// from this file.
...
// PostgreSQL with pgvector (matches VLAN 120 homelab image)
...
// Microsoft Garnet (RESP-compatible, matches VLAN 120 homelab cache).
...
// RabbitMQ with management UI (matches VLAN 120 homelab broker)
